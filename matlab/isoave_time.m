%
% Calculation of integer structure function scaling exponents from time-averaged and angle-averaged data
% S.Kurien
%
...
%name='/netscratch/skurien/dns_data/skhel512a/skhel512a'
%nx=512; delx_over_eta=1.15; epsilon=1.51;teddy = 1.05;
%times=[2.8:0.2:4.2];

%name='/netscratch/skurien/dns_data/skhel512a/skhel512a-trunc0032.'
%nx=512; delx_over_eta=1.15; epsilon=1.51;teddy = 1.05;
%times=[2.8:0.2:4.2];
...
set(gca,'fontsize',14)
lo_str = ['\langle \Delta u_L(r)^{',sprintf('%3.1f',i+1),'}\rangle'];
tr_str = ['\langle \Delta u_T(r)^{',sprintf('%3.1f',i+1),'}\rangle'];
