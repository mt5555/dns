...
fid = endianopen('~/projects/INCITE_runs/Intrepid/lowaspect_bous/n2048_d0.25_Ro0.01_nodamp/n2048_d0.25_Ro0.01_new_all.scalars-bous','r')
...
legend('$Q$', '$Q_{qg}$','$|f \partial_z \rho |$', '$|N \omega_3|^2$')
