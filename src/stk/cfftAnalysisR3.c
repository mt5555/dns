 ...
 *       
 * $Id: cfftAnalysisR3.c,v 1.1 2001-08-06 20:33:31 mt Exp $
 */

#include "cfft.h"

void cfftAnalysisR3(complex *x,complex *y,complex omega,int L,int N)
{
  ...
  for(j=0;j<N;j++)
      ...
      for(i=0;i<L;i++)
	{
	  ...
	  z0.im=a.im*(t1.im-t2.im);
	  z1.re=t0.im+a.re*(t1.im+t2.im);
	  z1.im=a.im*(t2.re-t1.re);
