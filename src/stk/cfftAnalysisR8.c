 ...
 *       
 * $Id: cfftAnalysisR8.c,v 1.1 2001-08-06 20:33:31 mt Exp $
 */

#include "cfft.h"

void cfftAnalysisR8(complex *x,complex *y,complex omega,int L,int N)
{
  ...
  for(j=0;j<N;j++)
    { 
      ...
      y0->re=t0.re+t1.re;
      y0->im=t0.im+t1.im;
      y1->re=t4.re+t5.re+t7.im;
      y1->im=t6.im+t5.im-t7.re;
      y2->re=t2.re+t3.im;
      y2->im=t2.im-t3.re;
      y3->re=t6.re-t5.re+t7.im;
      y3->im=t4.im-t5.im-t7.re;
      y4->re=t0.re-t1.re;
      y4->im=t0.im-t1.im;
      y5->re=t4.re-t5.re-t7.im;
      y5->im=t6.im-t5.im+t7.re;
      y6->re=t2.re-t3.im;
      y6->im=t2.im+t3.re;
      y7->re=t6.re+t5.re-t7.im;
      y7->im=t4.im+t5.im+t7.re;
      w.re=omega.re+1.0;
      w.im=omega.im;
      x0++;
      x1++;
