...
\frac{\partial}{\partial t} \int_V 
         \left[ .5 (u^2 + v^2 + w^2) +\frac{g}{\text{bous}}
           \theta^2\right] 
= \int_V \left[ .5 \nu \nabla^2 (u^2 + v^2 + w^2) 
...
\item[2.] Potential energy, $\frac{g}{\text{bous}} \theta^2$

\item[3.] Kinetic energy, $.5 ( u^2 + v^2 + w^2 )$ 
...
\item[6.] two-point correlation (coming)
