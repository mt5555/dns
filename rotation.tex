...
\dfrac{1}{L} \dfrac{\partial u_1}{\partial z} -  L \dfrac{\partial u_3}{\partial x}  \\[5mm]
...
\begin{pmatrix} u_1 \\
                ...
                L u_3 \\
\end{pmatrix} = 
\begin{pmatrix}  L  u_3 \omega_2' -  u_2 \omega_3'   \\
                   u_1 \omega_3' -   L u_3 \omega_1'   \\
...
\begin{pmatrix}  L  u_3 \omega_2' -  u_2 \omega_3'   \\
                   u_1 \omega_3' -   L u_3 \omega_1'   \\
              \dfrac{1}{L} \left(  u_2 \omega_1' - u_1 \omega_2' \right)  \\
\end{pmatrix}  
+ 
\begin{pmatrix} -f u_2 \\
                f u_1 \\
...
\[
<f,g> = \frac{1}{L} \iiint  f g  \, dx' \, dy' \, dz' =   \iiint  f g \, dx \, dy \, dz
...
\[
k = <\up,\up> = <u_1,u_1> + <u_2,u_2> + L^2 <u_3,u_3>
\]
and the helicity 
\[
  h  = w_1' u_1  + w_2' u_2 + L w_3' u_3
\]
As in example, using integer wave numbers $(l,m,n)$ (defined in the
next section), we have
\[
< \omega' , \Delta \up> = \sum (2 \pi)^2 (l^2 + m^2 + (n/L)^2) 
