...
\[
R_\lambda =   \sqrt{\frac{20}{3}} L^{2/3} k_\text{max}^{2/3}  =   2.0 k_\text{max}^{2/3}
\qquad
\Delta t / t_e =    .36 k_\text{max}^{-1}
\]
assuming $C=.5$
