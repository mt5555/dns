...
This case was run upto T = 690 in these units. This figure should be compared with Fig. 1 in SW02 for the $Fr = 0.21$, $k_f = 24$ case.
\begin{figure}[ht]
\centering
  \includegraphics[scale = 0.5]{Comp_SW02_fig1_Fr0.21_kf24}
...
this case at T=690, to be compared with SW02, Fig. 2. Note that SW02
ran this case upto T=900 and plot their spectra at that time. The total and $k_h=0$ agree very well qualitatively.
\begin{figure}[ht]
\centering
