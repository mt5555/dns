...
contribute to the most energetic low wave numvers (corresponding to the peak in the $k_h=0$ spectrum but they make the dominant contribution to the low wavenumbers $k < 8$ but the energy in these low modes is an order of magnitude less than the peak in $10< k <15$.  We also show in
addition the wave modes which SW02 does not show. We do not show the
potential energy spectrum which SW02 does show.
\begin{figure}[ht]
\centering 
