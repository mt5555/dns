...
This case was run upto about T = 1500 in these units. Note that SW02
...
\begin{figure}[ht]
\centering
  \includegraphics[scale = 0.7]{Comp_SW02_fig4_Nf100}
...
computed at our latest time of $T=1500$, to be compared with the SW02
...
the energy in the peak low-wavenumbers. We show in addition the wave
and vortical modes which SW02 does not show. We do not show the
potential energy spectrum which SW02 does show. An unexplained
difference is the 'peaky' nature of the low-mode energy distribution
($5< k < 10$) in SW02 Fig. 5. This does not appear in our runs.
\begin{figure}[ht]
\centering
  \includegraphics[scale = 0.7]{Comp_SW02_fig5}
\caption{Total energy and the projected wave, vortical and $k_h=0$ spectral distributions. To be compared with Figure 5 of SW02. \label{NF100_spec}}
\end{figure}
...
\begin{figure}[ht]
\centering
  \includegraphics[scale = 0.7]{Comp_SW02_fig4_Nf10}
\caption{Evolution in time of the kinetic energy. To be compared with $N/f = 10$ curve in Figure 4 of SW02. \label{NF10_time}}
\end{figure}
...
'peaky' nature of the low-mode energy distribution ($5< k < 10$) in
SW02 Fig. 5. This does not appear in our runs.  The $k_h = 0$ VSHF
modes carry most of the energy in the peak low-wavenumbers. The PV
(vortical) mode spectra also agree well in that they do not contribute
to the most energetic low wave numvers.  We also show in addition the
wave modes which SW02 does not show. We do not show the potential
energy spectrum which SW02 does show.
\begin{figure}[ht]
\centering 
 \includegraphics[scale = 0.7]{Comp_SW02_fig9}
\caption{Total energy and the projected wave, vortical and $k_h=0$ spectral distributions. To be compared with Figure 9 of SW02. \label{NF10_spec}}
\end{figure}
